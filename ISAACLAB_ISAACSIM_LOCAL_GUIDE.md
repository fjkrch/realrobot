...
```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p -c "print('Isaac Lab Python OK')"
```
...
Use `./isaaclab.sh -p` instead of plain `python` when a script needs Isaac Sim / Isaac Lab modules:

```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p path/to/script.py
```
...
```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p path/to/script.py --headless
```
...
```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p scripts/tutorials/00_sim/create_empty.py
```
...
```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p scripts/tutorials/02_scene/create_scene.py
```
...
```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p scripts/demos/arms.py
```
...
```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p scripts/demos/sensors/cameras.py
```
...
```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p scripts/environments/list_envs.py
```
...
```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p scripts/environments/random_agent.py \
...
```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/train.py \
  --task Isaac-Cartpole-v0 \
  --num_envs 64 \
  --headless
```
...
```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/play.py \
  --task Isaac-Cartpole-v0
```
...
```bash
cd /home/chyanin/IsaacLab
TERM=xterm conda run -n env_isaaclab ./isaaclab.sh -p your_script.py
```
...
```bash
conda run -n env_isaaclab ./isaaclab.sh -p scripts/tutorials/00_sim/create_empty.py
```
