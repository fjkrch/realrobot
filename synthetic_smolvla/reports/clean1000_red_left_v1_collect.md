...
Source episodes: 896 across 8 envs x 112 rounds.
Kept (measured success, no wrong-object): 250 (0.279).
...
| Metric | Count | Rate |
|---|---:|---:|
| Source episodes | 896 | 1.000 |
| Kept successes | 250 | 0.279 |
| Wrong-object lifts (source) | 0 | 0.000 |
| Limit-clamp episodes (source) | 0 | 0.000 |
| Object-collision episodes (source) | 197 | 0.220 |
| Gripper/table collision episodes (source) | 0 | 0.000 |
| Object sweep/slide episodes (source) | 559 | 0.624 |
...
- LeRobot dataset root: `/home/chyanin/Desktop/realrobot/synthetic_smolvla/datasets/clean1000_red_left_v1`
- LeRobot repo id: `local/clean1000_red_left_v1`
- Episode metadata JSONL (dense state/action + poses/rises/contact): `/home/chyanin/Desktop/realrobot/synthetic_smolvla/reports/clean1000_red_left_v1_manifest.jsonl`
- Sample frames: `synthetic_smolvla/reports/clean1000_red_left_v1_samples`
