...
Kept (measured success, no wrong-object): 121 (0.945).

Each kept episode is a DENSE rollout with real Isaac camera frames at every
control step (150 steps/episode, 256x256 RGB).

| Metric | Count | Rate |
|---|---:|---:|
| Source episodes | 128 | 1.000 |
| Kept successes | 121 | 0.945 |
...
| Object sweep/slide episodes (source) | 5 | 0.039 |
...
- LeRobot dataset root: `/home/chyanin/Desktop/realrobot/synthetic_smolvla/datasets/openarm_real_table_zero_v1_lift5cm_red_right_fallback_m2_150step_128`
- LeRobot repo id: `local/openarm_real_table_zero_v1_lift5cm_red_right_fallback_m2_150step_128`
- Episode metadata JSONL (dense state/action + poses/rises/contact): `/home/chyanin/Desktop/realrobot/synthetic_smolvla/reports/openarm_real_table_zero_v1_lift5cm_red_right_fallback_m2_150step_128_manifest.jsonl`
- Sample frames: `synthetic_smolvla/reports/openarm_real_table_zero_v1_lift5cm_red_right_fallback_m2_150step_128_samples`
