...
| Object-collision episodes (source) | 12 | 0.188 |
| Gripper/table collision episodes (source) | 0 | 0.000 |
| Object sweep/slide episodes (source) | 14 | 0.219 |
...
- LeRobot dataset root: `/home/chyanin/Desktop/realrobot/synthetic_smolvla/datasets/clean1000_smoke_tight_prepose_slew2`
- LeRobot repo id: `local/clean1000_smoke_tight_prepose_slew2`
- Episode metadata JSONL (dense state/action + poses/rises/contact): `/home/chyanin/Desktop/realrobot/synthetic_smolvla/reports/clean1000_smoke_tight_prepose_slew2_manifest.jsonl`
- Sample frames: `synthetic_smolvla/reports/clean1000_smoke_tight_prepose_slew2_samples`
