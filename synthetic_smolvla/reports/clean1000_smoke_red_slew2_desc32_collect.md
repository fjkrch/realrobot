...
Source episodes: 32 across 8 envs x 4 rounds.
Kept (measured success, no wrong-object): 13 (0.406).
...
| Metric | Count | Rate |
|---|---:|---:|
| Source episodes | 32 | 1.000 |
| Kept successes | 13 | 0.406 |
| Wrong-object lifts (source) | 0 | 0.000 |
| Limit-clamp episodes (source) | 0 | 0.000 |
| Object-collision episodes (source) | 9 | 0.281 |
| Gripper/table collision episodes (source) | 0 | 0.000 |
| Object sweep/slide episodes (source) | 19 | 0.594 |
...
- LeRobot dataset root: `/home/chyanin/Desktop/realrobot/synthetic_smolvla/datasets/clean1000_smoke_red_slew2_desc32`
- LeRobot repo id: `local/clean1000_smoke_red_slew2_desc32`
- Episode metadata JSONL (dense state/action + poses/rises/contact): `/home/chyanin/Desktop/realrobot/synthetic_smolvla/reports/clean1000_smoke_red_slew2_desc32_manifest.jsonl`
- Sample frames: `synthetic_smolvla/reports/clean1000_smoke_red_slew2_desc32_samples`
