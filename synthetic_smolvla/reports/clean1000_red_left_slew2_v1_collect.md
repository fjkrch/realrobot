...
Source episodes: 784 across 8 envs x 180 rounds.
Kept (measured success, no wrong-object): 250 (0.319).
...
| Metric | Count | Rate |
|---|---:|---:|
| Source episodes | 784 | 1.000 |
| Kept successes | 250 | 0.319 |
| Wrong-object lifts (source) | 0 | 0.000 |
| Limit-clamp episodes (source) | 0 | 0.000 |
| Object-collision episodes (source) | 331 | 0.422 |
| Gripper/table collision episodes (source) | 0 | 0.000 |
| Object sweep/slide episodes (source) | 531 | 0.677 |
...
- LeRobot dataset root: `/home/chyanin/Desktop/realrobot/synthetic_smolvla/datasets/clean1000_red_left_slew2_v1`
- LeRobot repo id: `local/clean1000_red_left_slew2_v1`
- Episode metadata JSONL (dense state/action + poses/rises/contact): `/home/chyanin/Desktop/realrobot/synthetic_smolvla/reports/clean1000_red_left_slew2_v1_manifest.jsonl`
- Sample frames: `synthetic_smolvla/reports/clean1000_red_left_slew2_v1_samples`
