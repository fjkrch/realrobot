...
Source episodes: 262 across 8 envs x 45 rounds.
Kept (measured success, no wrong-object): 250 (0.954).
...
| Metric | Count | Rate |
|---|---:|---:|
| Source episodes | 262 | 1.000 |
| Kept successes | 250 | 0.954 |
| Wrong-object lifts (source) | 0 | 0.000 |
| Limit-clamp episodes (source) | 0 | 0.000 |
| Object-collision episodes (source) | 3 | 0.011 |
...
- LeRobot dataset root: `/home/chyanin/Desktop/realrobot/synthetic_smolvla/datasets/clean1000_green_left_slew2_v1`
- LeRobot repo id: `local/clean1000_green_left_slew2_v1`
- Episode metadata JSONL (dense state/action + poses/rises/contact): `/home/chyanin/Desktop/realrobot/synthetic_smolvla/reports/clean1000_green_left_slew2_v1_manifest.jsonl`
- Sample frames: `synthetic_smolvla/reports/clean1000_green_left_slew2_v1_samples`
